...
float op_add1(float x)
{
    return x;
}
float op_chs(float x)
{
    return -x;
}
...
float op_lt(float x, float y)
{
    return x<y;
}
float op_eq(float x, float y)
{
    return x==y;
}
float op_gt(float x, float y)
{
    return x>y;
}
float op_elv(float x, float y, float z)
{
    if (x) return y;
    else return z;
}
